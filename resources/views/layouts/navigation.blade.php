        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('setores.index')" :active="request()->routeIs('setores.index')">
                        {{ __('Setores') }}
                    </x-nav-link>
                    <x-nav-link :href="route('empregados.index')" :active="request()->routeIs('empregados.index')">
                        {{ __('Empregados') }}
                    </x-nav-link>
                </div>
            </div>
